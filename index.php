...
class Spam {
    ...
    public function init() {
        ...
        for ($k = 0; $k < $ilosc_testow; $k++) {
             ...
             * to co ostatecznie uzyskujemy to wiadomosc czy ostatnie przeksztalcenie przy startowej liczbie parzystej ($a=0) przynioslo ostatecznie liczbe parzysta czy nieparzysta
             ...
             * jesli w obydwu przypadkach otrzymalismy liczby nieparzyste to znaczy ze wszyscy byli spamujacy => $sp = $len - $non_sp; gdzie $non_sp = 0
             * jesli w jednym z przypadkow otrzymalismy liczbe parzysta dla startujacej liczba parzystej ($a=0) oraz liczbe nieparzysta dla startujacej liczby nieparzystej ($b=1)
             * to znaczy ze nie spamujacych bedzie tyle ile w przedziale <$this->minX, $this->maxX> jest liczb parzystych oraz ze spamujacych bedzie: wielosc_przedzialu - ilosc_nie_spamujacych
             * jesli w jednym z przypadkow otrzymalismy liczbe nieparzysta dla startujacej liczba parzystej ($a=0) oraz liczbe parzysta dla startujacej liczby nieparzystej ($b=1)
             * to znaczy ze nie spamujacych bedzie tyle ile w przedziale <$this->minX, $this->maxX> jest liczb nieparzystych oraz ze spamujacych bedzie: wielosc_przedzialu - ilosc_nie_spamujacych
             */
            for ($i = 0; $i < $n; $i++) {
            ...
            // jesli ostatnia wygenerowana cyfra przez siec neuronowa startujac od liczby parzystej byla parzysta to wchodzimy w ponizszy warunek
            ...
            // jesli ostatnia wygenerowana cyfra przez siec neuronowa startujac od liczby nieparzystej byla parzysta to wchodzimy w ponizszy warunek
            // w warunku obliczamy ilosc nie spamujacych czyli tych dla ktorych wygenerowane byly liczby parzyste
